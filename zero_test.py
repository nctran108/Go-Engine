...
from go.encoders import alphazero
from go.agent import zero
from go import RL
...
def main():
    board_size = 9
    encoder = alphazero.ZeroEncoder(board_size)
    ...
    c1 = RL.ZeroExperienceCollector()
    c2 = RL.ZeroExperienceCollector()
    ...
    exp = RL.combine_zero_experience([c1, c2])
